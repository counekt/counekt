...
CREATE TABLE erc360 (
    ...
    CONSTRAINT fk_erc360_location_id FOREIGN KEY (location_id) REFERENCES location (id) ON DELETE SET NULL
);
...
CREATE TABLE referendum (
    ...
    CONSTRAINT fk_referendum_erc360_id FOREIGN KEY (erc360_id) REFERENCES erc360 (id)
);

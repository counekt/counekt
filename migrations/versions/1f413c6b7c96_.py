...
Revision ID: 1f413c6b7c96
Revises: 
Create Date: 2023-12-07 23:54:53.301759
...
def upgrade():
    ...
    sa.Column('token_ids_last_updated_at', sa.Integer(), nullable=True),
    ...
    sa.Column('token_residual_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['erc360_id'], ['erc360.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['erc360_token_id_id'], ['erc360_token_id.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    with op.batch_alter_table('erc360_to_user_request', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_erc360_to_user_request__type'), ['_type'], unique=False)
    ...
    with op.batch_alter_table('user_to_erc360_request', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_to_erc360_request__type'), ['_type'], unique=False)
    ...
    with op.batch_alter_table('user_to_user_request', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_to_user_request__type'), ['_type'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('user_to_user_request', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_user_to_user_request__type'))

    op.drop_table('user_to_user_request')
    with op.batch_alter_table('user_to_erc360_request', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_user_to_erc360_request__type'))
    ...
    with op.batch_alter_table('erc360_to_user_request', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_erc360_to_user_request__type'))

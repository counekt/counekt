...
Revision ID: 3b021305fbc3
Revises: a32326971686
Create Date: 2023-09-04 19:17:34.234221
...
revision = '3b021305fbc3'
down_revision = 'a32326971686'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['liquid_id'], ['bank.id'], ondelete='cascade'),

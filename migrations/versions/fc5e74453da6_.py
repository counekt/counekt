...
Revision ID: fc5e74453da6
Revises: 
Create Date: 2023-04-24 13:36:52.150571
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['convo_id'], ['conversation.id'], ),
    ...
    with op.batch_alter_table('associates', schema=None) as batch_op:
        batch_op.create_foreign_key(None, 'user', ['left_id'], ['id'])
        batch_op.create_foreign_key(None, 'user', ['right_id'], ['id'])

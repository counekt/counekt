...
define(['exports', './when-e6985d2a', './Check-24cae389', './Math-392d0035', './Cartesian2-a5d6dde9', './Transforms-81680c41'], function (exports, when, Check, _Math, Cartesian2, Transforms) { 'use strict';
  ...
  Plane.transform = function (plane, transform, result) {
    ...
    Transforms.Matrix4.multiplyByPointAsVector(transform, plane.normal, scratchNormal);
    Cartesian2.Cartesian3.normalize(scratchNormal, scratchNormal);

    Cartesian2.Cartesian3.multiplyByScalar(plane.normal, -plane.distance, scratchPosition);
    Transforms.Matrix4.multiplyByPoint(transform, scratchPosition, scratchPosition);
